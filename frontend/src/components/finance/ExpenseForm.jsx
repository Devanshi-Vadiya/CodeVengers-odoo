  ...
  return (
    <div className="panel p-6 flex flex-col h-full">
      <div className="mb-6 border-b border-app-border pb-4">
        <h3 className="text-lg font-bold font-display text-text-primary">Add Expense</h3>
        <p className="text-sm text-text-secondary mt-1">Log tolls, parking, and other operational costs.</p>
      </div>
