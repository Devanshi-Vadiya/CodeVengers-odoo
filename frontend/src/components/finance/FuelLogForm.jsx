...
export default function FuelLogForm({ onSubmit, loading, selectedVehicleId }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setFormData(prev => ({ ...prev, liters: '', cost: '' })); // reset form
  };
      ...
      <form onSubmit={handleSubmit} className="flex flex-col flex-1 space-y-5">
        ...
        <div className="mt-auto pt-6">
          <button
            ...
            className="w-full px-4 py-3 rounded-xl text-sm font-bold hover:brightness-110 transition-all active:scale-95 focus:outline-none disabled:opacity-50 disabled:pointer-events-none shadow-lg shadow-status-dispatched/20"
          >
